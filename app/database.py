...
# Create SSL context from certificate string
ssl_context = None
if settings.sslrootcert:  # Assuming `settings.sslrootcert` contains the certificate string
    ssl_context = ssl.create_default_context()
    ssl_context.load_verify_locations(cadata=settings.sslrootcert)
